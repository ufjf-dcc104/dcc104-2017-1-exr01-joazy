...
Sprite.prototype.desenharBloco = function (ctx) {
  ctx.save();
  ctx.translate(this.x, this.y);
  ctx.fillStyle = this.color;
...
Sprite.prototype.colidindo = function () {
this.vy =0;
this.vx=0;
this.ax =0;
this.ay=0;
...
Sprite.prototype.colidiuComBorda = function () {
  if(this.x-this.width/2 <= 0 ){
    this.vx=0;
    this.ax=0;
  }
  if(this.x + this.width/2 >700){
    this.vx=0;
    this.ax=0;
  }
